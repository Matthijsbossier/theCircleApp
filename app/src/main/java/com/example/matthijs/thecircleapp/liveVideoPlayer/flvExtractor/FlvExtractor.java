package com.example.matthijs.thecircleapp.liveVideoPlayer.flvExtractor;
...
public final class FlvExtractor implements Extractor, SeekMap {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
        ...
        public Extractor[] createExtractors() {
            return new Extractor[] {new com.example.matthijs.thecircleapp.liveVideoPlayer.flvExtractor.FlvExtractor()};
        }
